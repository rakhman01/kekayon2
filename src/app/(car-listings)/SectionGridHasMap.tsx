      ...
      <div className="relative flex min-h-screen">
        ...
        >
          ...
          <div className="fixed xl:sticky top-0 xl:top-[88px] left-0 w-full h-full xl:h-[calc(100vh-88px)] rounded-md overflow-hidden">
            ...
            {/* <GoogleMapReact
              bootstrapURLKeys={{ key: 'AIzaSyAGVJfZMAKYfZ71nzL_v5i3LjTTWnCYwTY' }}
            ...
            {/* <LoadScript googleMapsApiKey="AIzaSyAGVJfZMAKYfZ71nzL_v5i3LjTTWnCYwTY"> */}
              ...
              >
                {DEMO_CARS.map((car) => (
                  ...
                  // icon={
                  //   true
                  //     ? "/path/to/selected-marker-icon.png" // Replace with your icon URL for selected markers
                  //     : undefined // Default Google Maps marker
                  // }
                  />
                ))}
              </GoogleMap> */}
